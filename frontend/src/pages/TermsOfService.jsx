  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans text-gray-800">
      ...
      <section>
        ...
        <p className="mb-4">
          By using our services, you agree to comply with these terms and any applicable laws and regulations. You must not use our services for any unlawful or prohibited purpose. You may not use our services in any manner that could damage, disable, overburden, or impair our services or interfere with any other party's use of our services.
        </p>
        ...
        <h2 className="text-2xl font-semibold text-blue-600 mb-4">Content</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-blue-600 mb-4">Changes to These Terms</h2>
        <p className="mb-4">
