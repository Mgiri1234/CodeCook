...
const AboutUs = () => {
  return (
    <div className="p-5 font-sans">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-3">Welcome to <strong className="font-bold">CodeCook</strong> – your ultimate destination for honing algorithmic skills and acing coding challenges!</h2>
        
        <h3 className="text-xl font-semibold mb-2">Who I Am</h3>
        <p className="mb-3">CodeCook is a cutting-edge online judge platform dedicated to helping programmers of all levels improve their problem-solving abilities. Whether you're a beginner taking your first steps in coding or an experienced developer looking to sharpen your skills, CodeCook provides the perfect arena for you to practice, compete, and grow.
        CodeCook was pioneered by MGiri, a B.E. student from BITS Pilani, who is passionate about coding and education. With a vision to create a platform that would inspire and empower coders to reach their full potential, MGiri is committed to providing a world-class learning experience for all users.
        </p>
        
        <h3 className="text-xl font-semibold mb-2">My Mission</h3>
        <p className="mb-2">At CodeCook, my mission is to:</p>
        ...
        <h3 className="text-xl font-semibold mb-2">Why Choose CodeCook?</h3>
        <ul className="list-disc list-inside mb-3">
        ...
        <p className="mb-3">Whether you're preparing for coding interviews, participating in competitive programming, or simply looking to enhance your algorithmic thinking, CodeCook is the place for you. Join me today and become part of a dynamic community of passionate coders.</p>
        
        <h3 className="text-xl font-semibold mb-2">Contact Me</h3>
        <p className="mb-3">Have questions or need assistance? Reach out to me at <a href="mailto:meghaditya2015@gmail.com" className="text-blue-500 hover:text-blue-700">support@CodeCook.com</a>. I'm here to help!</p>
      </section>
